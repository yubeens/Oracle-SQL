...
group by address
order by address; 
--4.102 번 멤버의 전화번호를 010-1212-4444 로 수정
update member
...
--8. 102 번 멤버의 email을 test@test.com 수정
...
-- num : 시퀀스 (member_seq / 1 로 시작, 1씩 증가  최소값 1/ 사이클 없음, 캐쉬 없음)
create table member(
 num number,
 name varchar2(30),
 address varchar2(70),
...
insert into member
values(member_seq.nextval,'이순신1' ,'서울','010-2222-4444','25/01/01' );
commit;
select * from member;
--시퀀스 삭제
